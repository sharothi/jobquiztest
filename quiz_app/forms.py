...
class CreateStudentForm(forms.ModelForm):
    # institution_name = forms.CharField(widget=forms.TextInput(attrs={
    # 'class': 'form-control', 'placeholder': 'Type your name'}))

    # class_name = forms.Select(widget=forms.TextInput(attrs={
    # 'class': 'form-control', 'placeholder': 'Type your name'}))

    # roll_num = forms.IntegerField(widget=forms.TextInput(attrs={
    # 'class': 'form-control'}))
...
class ExaminationInfoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['exam_name', 'subject_name', 'teacher', 'per_ques_marks', 'total_time']
        widgets = {
            ...
            'per_ques_marks' : forms.NumberInput(attrs={'class': 'form-control'}),
